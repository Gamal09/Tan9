...
gdReader=loadXML("Calculators/IG/IGCSE-IG.xml");
/********Conditions******************/
            ...
            if (IGQualigyObject.AConditionFailed < 100) {
                    ...
                    if (IGBonus[B].subjectMark > 0) {//if there are valid AL or ASL subjects for the qualification move into results
                        ...
                        //**basem  if (IGQualigyObject.AConditionFailed > 0) {
                         switch (IGBonus[B].subjectStatus){
                            case 0:
                                analysisList.push(new Array(X + 1, Qualifications[X + 1][0], "مادة علي المستوي المتقدم", "أضيفت لتحقيق أحد شروط التأهيل", new Array(new Array(IGBonus[B].subjectName,IGBonus[B].subjectMark)), new Array()));
                            break;
                            case 1:
                ...
                for (var B = 0; B < IGBonus.length; B++) {
                    if (IGBonus[B].subjectMark > 0) {//if there are valid AL or ASL subjects for the qualification move into results
                        ...
                        switch (IGBonus[B].subjectStatus){
                            case 0:
                                analysisList.push(new Array(X + 1, "مادة علي المستوي المتقدم", "", "أضيفت لتحقيق أحد شروط التأهيل", new Array(new Array(IGBonus[B].subjectName, IGBonus[B].subjectMark)), new Array()));
                            break;
                            case 1:
                                analysisList.push(new Array(X + 1, "مادة علي المستوي المتقدم", "", "أضيفت لتحسين المجموع", new Array(new Array(IGBonus[B].subjectName, IGBonus[B].subjectMark)), new Array()));
                            break;
                            case -1:
                                analysisList.push(new Array(X + 1, Qualifications[X + 1][0], "", "أضيفت لتحسين المجموع", new Array(new Array(IGBonus[B].subjectName, IGBonus[B].subjectMark)), new Array()));
                            break;
