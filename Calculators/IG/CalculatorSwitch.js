...
function FillQualificationCB()
{
    ...
    if(QCB != null && Qualifications !=null ){
        for (var i = 3; i < Qualifications.length; i++) {
            AddQualification(QCB, Qualifications[i][0], i);
        }
    }
}

function StartCalculations(StudentSubjectList) {
    //Read LoadedSubject List
    FillQualificationCB();

       StudentASLSubjectList = StudentSubjectList // will be filitered at the bonus object
