function ShowQualificationAdmin(QualificationsArray,SeatNumber) {
...
//    WriteFloatingLayer();
    ...
    function GetQualificationInfo() {
        /*var qualificationDiv = FindControl('AllQualification'); 
        var QTableContents = "";
        ...
        for (var i = 0; i < QualificationObjectsArray.length; i++) {

                /*QTableContents += "	<tr>";
                QTableContents += "<td width=250>" + QualificationObjectsArray[i].sQualification + "</br></td>";*/
                 document.getElementById(SeatNumber + "-" + (i + 1)).innerHTML = QualificationObjectsArray[i].qMark;
