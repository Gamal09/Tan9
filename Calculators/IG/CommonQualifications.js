...
function ActivateAdvancedSubjectGroups(SubjectCode) {
    ...
    AdvancedArray.push(new Array('245,1245', '203,1203'))//ÑíÇÖå æÑíÇÖå ãÊÞÏã
    AdvancedArray.push(new Array('246,1246', '209,1209'))//ÃÍíÇÁ æÃÍíÇÁ ãÊÞÏã
    AdvancedArray.push(new Array('247,1247', '208,1208'))//ÝíÒíÇÁ æÝíÒíÇÁ ãÊÞÏã
    AdvancedArray.push(new Array('248,1248', '207,1207'))//ßíãíÇÁ æßíãíÇÁ ãÊÞÏã
    AdvancedArray.push(new Array('249,1249', '222,1222'))//áÛÉ ÝÑäÓíÉ æáÛÉ ÝÑäÓíÉ ãÊÞÏã
    AdvancedArray.push(new Array('250,1250', '220,1220'))//ßãÈíæÊÑ æßãÈíæÊÑ ãÊÞÏã
    AdvancedArray.push(new Array('258,1258', '204,205,1204,1205'))//ÝÑÚ ÑíÇÖíÇÊ æÝÑÚ ÑíÇÖíÇÊ ãÊÞÏã
    //Is Subject Advanced
...
function SortByMark(a, b) {
    return parseInt(a.subjectMark * 100) >= parseInt(b.subjectMark * 100)
}